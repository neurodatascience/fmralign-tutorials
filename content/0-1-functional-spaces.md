...
Past a small number of voxels, it's no longer possible to visualize the accompanying _N_-dimensional spaces!

```{margin}
[As Geoff Hinton said](https://twitter.com/videodrome/status/1005887240407379969?s=20), "To deal with hyper-planes in a 14-dimensional space, visualize a 3-D space and say 'fourteen' to yourself very loudly. Everyone does it."
```
